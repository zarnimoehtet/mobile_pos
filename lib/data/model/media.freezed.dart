...
abstract class $MediaCopyWith<$Res> {
  ...
  $Res call({@JsonKey(name: "Location") @HiveField(1) String? path});
}
...
class _$_Media implements _Media {
  const _$_Media(@JsonKey(name: "Location") @HiveField(1) this.path);
...
abstract class _Media implements Media {
  const factory _Media(
      @JsonKey(name: "Location") @HiveField(1) final String? path) = _$_Media;
